package com.taitrinh.online_auction.service.product;
...
import com.taitrinh.online_auction.entity.bid.BidHistory;
import com.taitrinh.online_auction.entity.product.Category;
import com.taitrinh.online_auction.entity.product.DescriptionLog;
import com.taitrinh.online_auction.entity.product.Product;
import com.taitrinh.online_auction.entity.product.ProductImage;
...
import com.taitrinh.online_auction.mapper.product.ProductMapper;
import com.taitrinh.online_auction.repository.auth.UserRepository;
import com.taitrinh.online_auction.repository.bid.BidHistoryRepository;
import com.taitrinh.online_auction.repository.comment.CommentRepository;
import com.taitrinh.online_auction.repository.product.CategoryRepository;
import com.taitrinh.online_auction.repository.product.DescriptionLogRepository;
...
import com.taitrinh.online_auction.service.integration.S3Service;
...
public class ProductService {
    ...
    public CreateProductResponse createProduct(CreateProductRequest request, Long sellerId) {
        ...
        if (request.getImages() == null || request.getImages().size() < 4) {
            throw new BadRequestException("Phải có ít nhất 1 ảnh chính và 3 ảnh phụ cho sản phẩm");
        }
        ...
        long primaryCount = request.getImages().stream()
                ...
                .count();
        if (primaryCount == 0) {
            throw new BadRequestException("Phải có một ảnh được đánh dấu là ảnh chính");
        }
        if (primaryCount > 1) {
