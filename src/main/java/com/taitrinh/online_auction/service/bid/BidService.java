package com.taitrinh.online_auction.service.bid;
...
import com.taitrinh.online_auction.entity.bid.BlockedBidder;
...
import com.taitrinh.online_auction.mapper.bid.BidMapper;
...
import com.taitrinh.online_auction.repository.bid.BlockedBidderRepository;
...
public class BidService {
        ...
        public void rejectBidder(Long productId, Long bidderId, Long sellerId) {
                ...
                // Check if the product is ended
                if (product.isEnded()) {
                        throw new ProductEndedException(
                                        "Sản phẩm đã kết thúc. Không thể loại bỏ bất kỳ ai vào lúc này");
                }
