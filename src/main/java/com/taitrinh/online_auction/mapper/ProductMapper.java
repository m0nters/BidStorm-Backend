...
public interface ProductMapper {
    ...
    @Mapping(target = "highestBidder", source = "product.highestBidder", qualifiedByName = "mapUserBasicInfo")
    @Mapping(target = "winner", source = "product.winner", qualifiedByName = "mapUserBasicInfo")
