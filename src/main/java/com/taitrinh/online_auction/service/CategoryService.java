...
public class CategoryService {
    ...
    public CategoryResponse updateCategory(Integer id, CreateCategoryRequest request) {
        ...
        // Check for duplicate name at the new level (excluding current category)
        Integer newParentId = request.getParentId();
        Integer oldParentId = category.getParent() != null ? category.getParent().getId() : null;

        // Only check for duplicates if moving to a different level or changing name
